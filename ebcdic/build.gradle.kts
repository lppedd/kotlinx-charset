...
val generateCharsets = tasks.register<GenerateCharsetTask>("generateCharsets") {
  ...
  // Latin 1 Denmark/Norway
  sbcs("IBM277") {
    aliases = listOf("cp277", "ibm-277", "277", "ebcdic-cp-dk", "ebcdic-cp-no", "csIBM277")
  }
  ...
  // Latin 1 Italy
  sbcs("IBM280") {
    aliases = listOf("cp280", "ibm-280", "280")
  }
  ...
  sbcs("IBM01141") {
    aliases = listOf("cp1141", "ccsid01141", "cp01141", "1141", "ebcdic-de-273+euro", "ibm1141", "ibm-1141")
    className = "IBM1141"
  }
  ...
  // Latin 1 Italy with Euro sign (like IBM280, but 0x9F = u00A4 -> u20AC)
  sbcs("IBM01144") {
    aliases = listOf("cp1144", "ccsid01144", "cp01144", "1144", "ebcdic-it-280+euro", "ibm1144", "ibm-1144")
    className = "IBM1144"
  }

  // Latin 1 United Kingdom/Ireland with Euro sign (like IBM285, but 0x9F = u00A4 -> u20AC)
  sbcs("IBM01146") {
    aliases = listOf("cp1146", "ccsid01146", "cp01146", "1146", "ebcdic-gb-285+euro", "ibm1146", "ibm-1146")
    className = "IBM1146"
  }

  // Latin 1 France with Euro sign (like IBM297, but 0x9F = u00A4 -> u20AC)
  sbcs("IBM01147") {
    aliases = listOf("cp1147", "ccsid01147", "cp01147", "1147", "ebcdic-fr-297+euro", "ibm1147", "ibm-1147")
    className = "IBM1147"
  }
